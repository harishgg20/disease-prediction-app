...
st.markdown("""
    <style>
        h1, h2, h3, h4, h5, h6 {
            color: #00ffcc !important; /* Titles */
        }
        label {
            color: #ffffff !important; /* Input field labels */
        }
        .stTextInput > label, .stNumberInput > label {
            color: #ffffff !important;
        }
        .css-1d391kg {  /* Optional: change default text */
            color: #dddddd !important;
        }
            /* Text inside header bar (including 'Deploy:' etc.) */
        header[class^="css-"] * {
            color: white !important;
        }
        /* Optional: white colon symbol if styled separately */
        header[class^="css-"]::after {
            color: white !important;
        }
        /* NEW: Target the paragraph/subheader text directly */
        .stMarkdown p {
            color: white !important;
        }
    </style>
